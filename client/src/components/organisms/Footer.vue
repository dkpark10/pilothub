  ...
  <footer>
    <div class="footer_top">
      ...
      <div class="font_size_controller_wrapper">
        <button class="footer_button" :style="{ width: '43px' }">
          <FontSmaller />
        </button>
        <button class="footer_button" :style="{ width: '44px' }">
          <FontLouder />
        </button>
      </div>
    </div>
    <div>
      <div class="footer_bottom" :style="{ height: '44px' }">
        <div class="footer_bottom_content1">
          <button class="footer_button" :style="style">로그인</button>
          <button class="footer_button" :style="style">pc버전</button>
          <button class="footer_button" :style="style">맨 위로</button>
        </div>
      </div>
