  ...
  return createRouter({
    ...
    routes: [
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: ranking */ "../components/page/Ranking.vue"
          ),
      },
      {
        path: "/recent",
        ...
        component: () =>
          import(
            /* webpackChunkName: recentreadpost */ "../components/page/RecentReadPost.vue"
          ),
      },
      {
        path: "/post/:id",
        ...
        component: () =>
          import(
            /* webpackChunkName: postdetail */ "../components/page/PostDetail.vue"
          ),
      },
      {
        path: "/:category",
